...
const MovieItem = ({ movie }) => {
  ...
  return (
    <div className='relative w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block rounded-lg overflow-hidden cursor-pointer m-2'>
      ...
      <div className='absolute top-0 left-0 w-full h-40 bg-black opacity-0 hover:opacity-80 transition-opacity duration-500'>
        <p className='whitespace-normal text-xs md:text-sm flex justify-center items-center h-full font-nsans-bold transition-opacity duration-300'>{movie.title}</p>
