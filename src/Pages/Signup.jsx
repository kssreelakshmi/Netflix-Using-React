    ...
    <div className='max-w-[450px] h-[600px] mx-auto bg-black/70 rounded-xl '>
      <div className='max-w-[320px] mx-auto py-16'>
        ...
        <form className='w-full flex flex-col py-4'onSubmit={handleForm}>
          ...
          placeholder='username' autoComplete='username'value={username} onChange={(e)=>setUsername(e.target.value)}/>
          ...
          <div className='flex justify-between items-center text-gray-600'>
            ...
            <p className='my-4 flex'>
              <span className='text-gray-600 m-2'>Already SubScribed to Netflix</span>
